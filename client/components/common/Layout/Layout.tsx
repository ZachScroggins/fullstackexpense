    ...
    <>
      <div className='min-h-full'>
        ...
        <div className='flex flex-col lg:pl-64'>
          {/* Search header */}
          <div className='sticky top-0 z-30 flex flex-shrink-0 h-16 bg-white border-b border-gray-200 lg:hidden'>
            <button
              type='button'
            ...
            <div className='flex justify-between flex-1 px-4 sm:px-6 lg:px-8'>
              <div className='flex flex-1'>
                ...
                <Link href='/'>
                  <a className='flex items-center flex-shrink-0 text-xl font-bold tracking-wide text-gray-700 underline decoration-fuchsia-300 decoration-2 underline-offset-2'>
                    <SparklesIcon
                      className='hidden w-6 h-6 mr-2 xs:inline text-fuchsia-400'
                      aria-hidden={true}
                    />
                    FullStackExpense
                  </a>
