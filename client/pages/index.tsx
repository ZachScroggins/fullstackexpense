...
const Home: NextPage = () => {
  return (
    <div className='relative min-h-screen overflow-hidden bg-gray-50'>
      <div
        className='z-0 hidden pointer-events-none sm:block sm:absolute sm:inset-y-0 sm:h-full sm:w-full'
        aria-hidden='true'
      >
      ...
      <main className='relative z-10 flex items-center justify-center h-full min-h-screen px-4 mx-auto max-w-7xl'>
        <div className='text-center'>
          ...
          <p className='max-w-md mx-auto mt-3 text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl'>
            Ubuntu, PHP, and MySQL API Server for the back end. Statically
          ...
          <div className='max-w-md mx-auto mt-5 sm:flex sm:justify-center md:mt-8'>
            <div className='rounded-md shadow'>
              <Link href='/expenses'>
                <a className='flex items-center justify-center w-full px-8 py-3 text-base font-medium text-white border border-transparent rounded-md cursor-pointer bg-fuchsia-600 hover:bg-fuchsia-700 md:py-4 md:text-lg md:px-10'>
                  Get started
                </a>
              </Link>
            </div>
